...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      "Exile 2 is by the CTE team. They are held here so that the GitHub Pages build of this",
      "project has data to load.",
      "",
      "Nothing here grants you any right in them: forking the planner does not carry a right",
      "to redistribute the art. See NOTICE on `main`.",
      "",
    ].join("\n"),
  );
